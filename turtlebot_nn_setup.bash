...
chmod +x gym_ws/src/turtlebot/turtlebot_gazebo/env-hooks/25.turtlebot-gazebo.sh.em
bash gym_ws/src/turtlebot/turtlebot_gazebo/env-hooks/25.turtlebot-gazebo.sh.em
...
mkdir -p gym_ws/src/kobuki/kobuki_description
mkdir -p gym_ws/src/kobuki/kobuki_description/meshes
